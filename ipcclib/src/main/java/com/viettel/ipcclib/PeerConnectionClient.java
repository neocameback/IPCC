...
public class PeerConnectionClient {
  ...
  private void createPeerConnectionInternal(EglBase.Context renderEGLContext) {
    ...
    //List<PeerConnection.IceServer> lstIceServer =new ArrayList<>();
    //PeerConnection.IceServer iceServer =new PeerConnection.IceServer();
    //lstIceServer.add();
    PeerConnection.RTCConfiguration rtcConfig = new PeerConnection.RTCConfiguration(AppRTCClient.SignalingParameters.iceServers);
